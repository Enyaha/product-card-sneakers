...
class ShowInfo {
  ...
  init() {
    this.btns.forEach(btn => {
      btn.addEventListener('click', () => {
        const sibling = btn.closest('.module__info-show').nextElementSibling; // sibling.style.display = 'block';
...
class MainSlider extends _slider__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  bindTriggers() {
    ...
    this.btnSelect(this.prevModule, -1);
    this.btnSelect(this.nextModule, 1);
  }
